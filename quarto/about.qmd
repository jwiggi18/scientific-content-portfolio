---
title: "About"
pagetitle: "About — Jodie Wiggins, PhD"
...
![Jodie Wiggins, PhD](assets/headshot.jpg){.headshot fig-alt="Headshot of Jodie Wiggins"}

# About

::: {.lead}
Nothing lights my brain up like an intellectual challenge which is probably why I've spent most of my career figuring out and explaining complex science.
:::

I build content and learning systems that work, and I measure whether they do.
...
I think carefully about where people get lost and I design backward from that. I'm most useful when the problem is *we have complex information and the people who need it aren't getting it.* That could be a content problem, a structure problem, or sometimes a trust problem.

```{=html}
<div class="pull-quote">I know how to work on all three.</div>
```
...
After a decade in academia, I want to do this work somewhere it lives closer to where scientific information actually meets people's lives. Medical communications. Scientific content strategy. Patient education. Editorial leadership. Same skills, different impact.

## A note on lived experience

I've also navigated the medical system as a complex patient — hEDS, MCAS, dysautonomia.
...
That perspective shapes how I write for patients, why I'm advising the Rare Disease Advocacy Club, and the kind of work I want to do next.

## What I'm looking for

```{=html}
<div class="pull-quote">Roles where the work is substantive, the team is competent, and the mission is real.</div>
```
